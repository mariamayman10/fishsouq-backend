...
namespace FishShop.API.Features.Auth;
...
public static class IdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("/refresh", async Task<Results<Ok<AccessTokenResponse>, UnauthorizedHttpResult>>
            ...
            IConfiguration configuration) =>
        {
            ...
            var principal = await signInManager.CreateUserPrincipalAsync(user);
            var newRefreshToken = TokenGenerator.GenerateRefreshToken(refreshTokenProtector, principal, timeProvider);
